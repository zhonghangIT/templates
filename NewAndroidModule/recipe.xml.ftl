...
<#if !createActivity>
    ...
    <instantiate from="root/src/app_package/base/IModle.java.ftl"
                    to="${escapeXmlAttribute(srcOut)}/base/IModle.java" />
    <instantiate from="root/src/app_package/base/IPresenter.java.ftl"
                    to="${escapeXmlAttribute(srcOut)}/base/IPresenter.java" />
    <instantiate from="root/src/app_package/base/IView.java.ftl"
                    to="${escapeXmlAttribute(srcOut)}/base/IView.java" />
